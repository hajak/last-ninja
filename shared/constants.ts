...
// ============================================
// Hazards - Collision detection range
// ============================================
export const HAZARD = {
  COLLISION_RADIUS: 0.8, // Distance to trigger hazard damage
  RESPAWN_DELAY: 500, // Ms before respawn after hazard hit
};
...
// UI / Visual
// ============================================
export const CAMERA_ZOOM_LEVELS = [0.6, 0.8, 1.0, 1.2];
